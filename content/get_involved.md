---
description: Get involved in developing openage
keywords:
- participation
- help
- take part
...
We always welcome new contributors! openage is a huge and ambitious project. There is more work than our small core dev team can handle. The openage community is very open, welcoming and supportive. No resumé or CV needed! If you’ve got the enthusiasm, you’re all welcome. Get in contact with us if you have any issues getting started.

## Contact us

Do you have ideas how to make openage a better engine or suggestions for features that you would like to see in openage? 
There are a few different channels that we use and listen to for features and other general information.

 - [Reporting Bugs](https://github.com/SFTtech/openage/issues)
 - [Reddit](https://www.reddit.com/r/openage)
 - [Chatroom (Matrix)](https://riot.im/app/#/room/#sfttech:matrix.org)
 - [Chat room (IRC)](https://webchat.freenode.net/?channels=sfttech)
